...
/**
 * Las notificaciones se muestran de forma dinamica como respuesta a una acción por parte del usuario
 * pueden tener la opción de que el usuario las cierre o bien cerrarse trancurrido un tiempo establecido.
 */
